    ...
    return (
        <>
            <div className='size-noheader grid grid-cols-1 p-4 gap-5 lg:grid-cols-2 border-4 border-yellow-500'>
                <div className="h-[45vh] lg:h-2/3 bg-[url(/cave-image-rock.png)] bg-cover bg-no-repeat bg-center text-white rounded-lg border-4 border-white">
                    <PointsBar />
                    <ClickBar />
                    <Rock />
                </div>
                <div className="h-full lg:h-2/3 text-white rounded-lg bg-[url(/cave-image-upgrade.png)] bg-cover bg-no-repeat bg-right-top overflow-y-auto scroll-personalizado border-4 border-red-500">
