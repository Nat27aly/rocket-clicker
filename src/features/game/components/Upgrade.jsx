        ...
        <>
            <div onClick={handleBuyUpgrade}
                 className={cn(
                     ...
                     "select-none bg-gray-800 hover:bg-gray-700 text-white border-4 border-yellow-500 rounded-2xl h-25 mx-auto my-5 flex justify-between w-5/6 sm:w-1/2 md:w-5/6 lg:w-3/4 xl:w-5/6 2xl:w-160 transition-colors duration-300 cursor-pointer")}>
